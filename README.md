...
5. **Architectural Rigor:** An extensive 3-page architectural teardown is provided in `architecture.pdf`.
...
Please refer to `architecture.pdf` for the detailed strategy covering Kubernetes node distribution, Context Window Overflow avoidance, Redis caching, and graph database storage.
